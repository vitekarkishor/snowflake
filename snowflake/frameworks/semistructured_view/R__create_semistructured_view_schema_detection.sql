CREATE OR REPLACE PROCEDURE COM.CREATE_SEMISTRUCTURED_VIEW_SCHEMA_DETECTION("EXECUTION_ID" VARCHAR(16777216), "START_TIME" VARCHAR(16777216), "CONSTRAINTS_LIST" VARCHAR(16777216))
...
var query_cmd = "select distinct concat('$1:',column_name,'::varchar as ',column_name) from table (INFER_SCHEMA(LOCATION => '@COM.EXT_STAGE_RDB_PARQUET/" + file_prefix_path + "', FILE_FORMAT => '" + file_format + "'));"
