CREATE OR REPLACE PROCEDURE COM.CREATE_SEMISTRUCTURED_VIEW_SCHEMA_DETECTION_V1("EXECUTION_ID" VARCHAR(16777216), "START_TIME" VARCHAR(16777216), "CONSTRAINTS_LIST" VARCHAR(16777216))
