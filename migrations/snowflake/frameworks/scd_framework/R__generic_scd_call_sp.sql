CREATE OR REPLACE PROCEDURE COM.GENERIC_SCD_CALL_SP("EXECUTION_ID" VARCHAR(16777216), "START_TIME" VARCHAR(16777216), "CONSTRAINTS_LIST" VARCHAR(16777216))
...
try {
    ...
    if (tgt_schema != ''){
        ...
        constraint_list_upload_target_json["executed_sp"] = "COM.DATA_LOAD_SCD1_WITH_DELETE_SP";
        ...
        var sql_stmt = `CALL COM.DATA_LOAD_SCD1_WITH_DELETE_SP(:1,:2);`;
        ...
        var scd_result = "No Records found in SCD mapping table.";
    }
    return 'Success -> SCD Called Successfully : ' + scd_result;
}
catch (err) {
    ...
    var dtls_after_exec = JSON.stringify(
        {
            ...
            "EXECUTED_SP" : "COM.DATA_LOAD_SCD1_WITH_DELETE_SP",
